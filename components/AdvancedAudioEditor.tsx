                  ...
                  onApplyPreset={async (preset: LoFiPreset) => {
                    ...
                    try {
                      ...
                      const mergedEffects: AudioEffects = {
                        ...defaultEffects,
                        // Override with preset effects where they exist
                        ...
                        compressor: { ...defaultEffects.compressor, ...(preset.effects.compressor || {}) },
                        limiter: { ...defaultEffects.limiter, ...(preset.effects.limiter || {}) },
                        tapeSaturation: { ...defaultEffects.tapeSaturation, ...(preset.effects.tapeSaturation || {}) },
                        bitCrusher: { ...defaultEffects.bitCrusher, ...(preset.effects.bitCrusher || {}) },
                        sidechain: { ...defaultEffects.sidechain, ...(preset.effects.sidechain || {}) },
                        chorus: { ...defaultEffects.chorus, ...(preset.effects.chorus || {}) },
                        flanger: { ...defaultEffects.flanger, ...(preset.effects.flanger || {}) },
                        phaser: { ...defaultEffects.phaser, ...(preset.effects.phaser || {}) },
                        tremolo: { ...defaultEffects.tremolo, ...(preset.effects.tremolo || {}) },
                        vibrato: { ...defaultEffects.vibrato, ...(preset.effects.vibrato || {}) },
                        wahWah: { ...defaultEffects.wahWah, ...(preset.effects.wahWah || {}) },
                        multiBandEQ: { ...defaultEffects.multiBandEQ, ...(preset.effects.multiBandEQ || {}) },
                        noiseGate: { ...defaultEffects.noiseGate, ...(preset.effects.noiseGate || {}) },
                        exciter: { ...defaultEffects.exciter, ...(preset.effects.exciter || {}) },
                        stereoWidener: { ...defaultEffects.stereoWidener, ...(preset.effects.stereoWidener || {}) },
                        pan: { ...defaultEffects.pan, ...(preset.effects.pan || {}) },
                        autoPan: { ...defaultEffects.autoPan, ...(preset.effects.autoPan || {}) },
                        ringModulator: { ...defaultEffects.ringModulator, ...(preset.effects.ringModulator || {}) },
                        granular: { ...defaultEffects.granular, ...(preset.effects.granular || {}) },
                        bandpass: { ...defaultEffects.bandpass, ...(preset.effects.bandpass || {}) },
                      };
